...
public class EmailController {
    ...
    public ResponseEntity sendVerificationCode(@Valid @RequestBody EmailRequest emailRequest) {
    ...
    public boolean verifyCode(@Valid @RequestBody EmailVerificationRequest emailVerificationRequest) {

        return emailService.verify(emailVerificationRequest);
    }
}
